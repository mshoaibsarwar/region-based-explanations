...
<p align="center">
  <img src="figures/protocol7_chair.png"/>
  <img src="figures/protocol7_desk.png"/>
</p>
...
├── run\_rshap.py            # Run complete R-SHAP analysis pipeline
├── figures/
│   ├── pipeline.png
│   ├── protocol1\_sphere\_manifold.png
│   ├── protocol7\_chair.png
│   └── protocol7\_desk.png
...
@article{sarwar2026rshap,
  ...
  author={Sarwar, Muhammad Shoaib and Harinck, Marc F. and Ahmed, Faizan},
  year={2026}
}
```
